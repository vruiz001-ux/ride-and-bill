      ...
      <div className="w-full max-w-sm">
        ...
        <Card>
          <CardContent className="p-6">
            ...
            <div className="mt-6 rounded-xl bg-neutral-50 p-4 text-sm text-neutral-500 dark:bg-neutral-800/50">
              Sign in with Google to connect your Gmail and automatically import Uber & Bolt receipts.
            </div>
          </CardContent>
        </Card>

        <p className="mt-6 text-center text-sm text-neutral-400">
          Don&apos;t have an account? <button onClick={() => signIn("google", { callbackUrl: "/dashboard" })} className="text-neutral-900 underline dark:text-white">Start free</button>
        </p>
      </div>
    </div>
  );
